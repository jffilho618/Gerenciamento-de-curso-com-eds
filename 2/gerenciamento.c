...
void menu_principal()
{
    ...
    printf("║ [2] TESTES DE TEMPO NA AVL                         ║\n");
    printf("║ [3] SOBRE                                          ║\n");
    printf("║ [0] SAIR                                           ║\n");
    printf("╚════════════════════════════════════════════════════╝\n\n");
}
...
void menu_testes(){
    ...
    printf("║ [2] PREENCHER ARVORE CURSOS CRESCENTE  AVL         ║\n");
    printf("║ [3] PREENCHER ARVORE CURSOS DECRESCENTE  AVL       ║\n");
    printf("║ [4] TESTE DE INSERCAO AVL                          ║\n");
    printf("║ [5] TAMANHO DA ARVORE                              ║\n");
    printf("║ [6] PRENCHER ALUNOS E DISCIPLINAS AVL              ║\n");
    printf("║ [7] TESTE DE BUSCA AVL                             ║\n");
    printf("║ [0] SAIR                                           ║\n");
    printf("╚════════════════════════════════════════════════════╝\n\n");
}
...
// Cadastro automático de cursos avl
...
int tamanho_notas(No_notas *raiz){
    ...
    if(raiz == NULL){
        ...
        retorno = 1 + tamanho_notas(raiz->esq) + tamanho_notas(raiz->dir);
    }
}
